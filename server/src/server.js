...
const PORT= process.env.PORT||6000 ;// we can define the configurable env.PORT in package json with start or wtach script it up to you by using which command you use to run the server 
